				...
				<div class="col-sm-6">
					<ul class="ul_contacts">
						<li>
							...
							<p><a href="http://<?=get_post_meta($post->ID, 'website', true);?>" target="_blank"><?=get_post_meta($post->ID, 'website', true);?></a></p>
						</li>
						<li>
							<h3><i class="icon icon-basic-geolocalize-05"></i> Адрес:</h3>
							<p><?=get_post_meta($post->ID, 'adress', true);?></p>
						</li>
						<li>
							<h3><i class="icon icon-basic-smartphone"></i> Телефон:</h3>
							<p><?=get_post_meta($post->ID, 'telephone', true);?></p>
						</li>
					</ul>
				</div>
				<div class="col-sm-6">
